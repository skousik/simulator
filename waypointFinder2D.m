...
%
% This is an A* path planner for small autonomous robots. Given start and
% goal points and obstacles defined as counterclockwise contours, the
% waypoint finder finds a collision avoiding path through the world.
%
...
%   wpf.updateGraphWeights(wpf,obstacles_as_CCW_contours)
